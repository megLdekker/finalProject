var drawsad1= function(sad,target,graphDim,xScale,yScale,colorScale)
{
...
var sadPromise = d3.csv("Data/sadData.csv");
var succFCN = function(sads)
{
    console.log("sads",sads);
    initGraph(sads)
}
var failFCN = function(error)
{
    console.log("That's Rough, Buddy",error);
}
sadPromise.then(succFCN,failFCN)